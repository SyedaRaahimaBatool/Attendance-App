...
public class com_ajstudios_easyattendance_realm_Class_NamesRealmProxy extends com.ajstudios.easyattendance.realm.Class_Names
    implements RealmObjectProxy, com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface {
    ...
    private ProxyState<com.ajstudios.easyattendance.realm.Class_Names> proxyState;

    com_ajstudios_easyattendance_realm_Class_NamesRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ajstudios.easyattendance.realm.Class_Names>(this);
    ...
    @SuppressWarnings("cast")
    public static com.ajstudios.easyattendance.realm.Class_Names createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ajstudios.easyattendance.realm.Class_Names obj = realm.createObjectInternal(com.ajstudios.easyattendance.realm.Class_Names.class, true, excludeFields);

        final com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static com.ajstudios.easyattendance.realm.Class_Names createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.ajstudios.easyattendance.realm.Class_Names obj = new com.ajstudios.easyattendance.realm.Class_Names();
        final com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_ajstudios_easyattendance_realm_Class_NamesRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Class_Names.class), false, Collections.<String>emptyList());
        io.realm.com_ajstudios_easyattendance_realm_Class_NamesRealmProxy obj = new io.realm.com_ajstudios_easyattendance_realm_Class_NamesRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ajstudios.easyattendance.realm.Class_Names copyOrUpdate(Realm realm, Class_NamesColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Class_Names object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Class_Names) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.ajstudios.easyattendance.realm.Class_Names copy(Realm realm, Class_NamesColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Class_Names newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Class_Names) cachedRealmObject;
        }

        com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface realmObjectSource = (com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) newObject;

        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Class_Names.class);
        ...
        io.realm.com_ajstudios_easyattendance_realm_Class_NamesRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.ajstudios.easyattendance.realm.Class_Names object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Class_Names.class);
        long tableNativePtr = table.getNativePtr();
        Class_NamesColumnInfo columnInfo = (Class_NamesColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Class_Names.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$id = ((com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$name_class = ((com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) object).realmGet$name_class();
        ...
        String realmGet$name_subject = ((com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) object).realmGet$name_subject();
        ...
        String realmGet$position_bg = ((com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) object).realmGet$position_bg();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        Class_NamesColumnInfo columnInfo = (Class_NamesColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Class_Names.class);
        com.ajstudios.easyattendance.realm.Class_Names object = null;
        while (objects.hasNext()) {
            object = (com.ajstudios.easyattendance.realm.Class_Names) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ajstudios.easyattendance.realm.Class_Names object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Class_Names.class);
    ...
    public static com.ajstudios.easyattendance.realm.Class_Names createDetachedCopy(com.ajstudios.easyattendance.realm.Class_Names realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ajstudios.easyattendance.realm.Class_Names unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ajstudios.easyattendance.realm.Class_Names();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ajstudios.easyattendance.realm.Class_Names) cachedObject.object;
            }
            unmanagedObject = (com.ajstudios.easyattendance.realm.Class_Names) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface unmanagedCopy = (com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) unmanagedObject;
        com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface realmSource = (com_ajstudios_easyattendance_realm_Class_NamesRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_ajstudios_easyattendance_realm_Class_NamesRealmProxy aClass_Names = (com_ajstudios_easyattendance_realm_Class_NamesRealmProxy)o;
