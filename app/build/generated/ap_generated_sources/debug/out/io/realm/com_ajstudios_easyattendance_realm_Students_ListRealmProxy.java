...
public class com_ajstudios_easyattendance_realm_Students_ListRealmProxy extends com.ajstudios.easyattendance.realm.Students_List
    implements RealmObjectProxy, com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface {
    ...
    private ProxyState<com.ajstudios.easyattendance.realm.Students_List> proxyState;

    com_ajstudios_easyattendance_realm_Students_ListRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ajstudios.easyattendance.realm.Students_List>(this);
    ...
    @SuppressWarnings("cast")
    public static com.ajstudios.easyattendance.realm.Students_List createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ajstudios.easyattendance.realm.Students_List obj = realm.createObjectInternal(com.ajstudios.easyattendance.realm.Students_List.class, true, excludeFields);

        final com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static com.ajstudios.easyattendance.realm.Students_List createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.ajstudios.easyattendance.realm.Students_List obj = new com.ajstudios.easyattendance.realm.Students_List();
        final com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_ajstudios_easyattendance_realm_Students_ListRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Students_List.class), false, Collections.<String>emptyList());
        io.realm.com_ajstudios_easyattendance_realm_Students_ListRealmProxy obj = new io.realm.com_ajstudios_easyattendance_realm_Students_ListRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ajstudios.easyattendance.realm.Students_List copyOrUpdate(Realm realm, Students_ListColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Students_List object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Students_List) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.ajstudios.easyattendance.realm.Students_List copy(Realm realm, Students_ListColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Students_List newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Students_List) cachedRealmObject;
        }

        com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface realmObjectSource = (com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) newObject;

        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Students_List.class);
        ...
        io.realm.com_ajstudios_easyattendance_realm_Students_ListRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.ajstudios.easyattendance.realm.Students_List object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Students_List.class);
        long tableNativePtr = table.getNativePtr();
        Students_ListColumnInfo columnInfo = (Students_ListColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Students_List.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$id = ((com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$name_student = ((com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) object).realmGet$name_student();
        ...
        String realmGet$regNo_student = ((com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) object).realmGet$regNo_student();
        ...
        String realmGet$mobileNo_student = ((com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) object).realmGet$mobileNo_student();
        ...
        String realmGet$class_id = ((com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) object).realmGet$class_id();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        Students_ListColumnInfo columnInfo = (Students_ListColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Students_List.class);
        com.ajstudios.easyattendance.realm.Students_List object = null;
        while (objects.hasNext()) {
            object = (com.ajstudios.easyattendance.realm.Students_List) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ajstudios.easyattendance.realm.Students_List object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Students_List.class);
    ...
    public static com.ajstudios.easyattendance.realm.Students_List createDetachedCopy(com.ajstudios.easyattendance.realm.Students_List realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ajstudios.easyattendance.realm.Students_List unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ajstudios.easyattendance.realm.Students_List();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ajstudios.easyattendance.realm.Students_List) cachedObject.object;
            }
            unmanagedObject = (com.ajstudios.easyattendance.realm.Students_List) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface unmanagedCopy = (com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) unmanagedObject;
        com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface realmSource = (com_ajstudios_easyattendance_realm_Students_ListRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_ajstudios_easyattendance_realm_Students_ListRealmProxy aStudents_List = (com_ajstudios_easyattendance_realm_Students_ListRealmProxy)o;
