...
public class com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy extends com.ajstudios.easyattendance.realm.Attendance_Students_List
    implements RealmObjectProxy, com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface {
    ...
    private ProxyState<com.ajstudios.easyattendance.realm.Attendance_Students_List> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ajstudios.easyattendance.realm.Attendance_Students_List>(this);
    ...
    @SuppressWarnings("cast")
    public static com.ajstudios.easyattendance.realm.Attendance_Students_List createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ajstudios.easyattendance.realm.Attendance_Students_List obj = null;
        if (update) {
            Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
            Attendance_Students_ListColumnInfo columnInfo = (Attendance_Students_ListColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Students_List.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("unique_ID")) {
                if (json.isNull("unique_ID")) {
                    obj = (io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy) realm.createObjectInternal(com.ajstudios.easyattendance.realm.Attendance_Students_List.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy) realm.createObjectInternal(com.ajstudios.easyattendance.realm.Attendance_Students_List.class, json.getString("unique_ID"), true, excludeFields);
                }
            } else {
        ...
        final com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) obj;
    ...
    public static com.ajstudios.easyattendance.realm.Attendance_Students_List createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.ajstudios.easyattendance.realm.Attendance_Students_List obj = new com.ajstudios.easyattendance.realm.Attendance_Students_List();
        final com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Students_List.class), false, Collections.<String>emptyList());
        io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy obj = new io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ajstudios.easyattendance.realm.Attendance_Students_List copyOrUpdate(Realm realm, Attendance_Students_ListColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Attendance_Students_List object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Attendance_Students_List) cachedRealmObject;
        }

        com.ajstudios.easyattendance.realm.Attendance_Students_List realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
            long pkColumnIndex = columnInfo.unique_IDIndex;
            String value = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$unique_ID();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy();
    ...
    public static com.ajstudios.easyattendance.realm.Attendance_Students_List copy(Realm realm, Attendance_Students_ListColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Attendance_Students_List newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Attendance_Students_List) cachedRealmObject;
        }

        com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface realmObjectSource = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) newObject;
        ...
        io.realm.com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.ajstudios.easyattendance.realm.Attendance_Students_List object, Map<RealmModel,Long> cache) {
        ...
        Attendance_Students_ListColumnInfo columnInfo = (Attendance_Students_ListColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
        long pkColumnIndex = columnInfo.unique_IDIndex;
        String primaryKeyValue = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$unique_ID();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$studentName = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$studentName();
        ...
        String realmGet$studentRegNo = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$studentRegNo();
        ...
        String realmGet$attendance = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$attendance();
        ...
        String realmGet$mobNo = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$mobNo();
        if (realmGet$mobNo != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.mobNoIndex, rowIndex, realmGet$mobNo, false);
        }
        String realmGet$classID = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$classID();
        if (realmGet$classID != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.classIDIndex, rowIndex, realmGet$classID, false);
        }
        String realmGet$date_and_classID = ((com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) object).realmGet$date_and_classID();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        Attendance_Students_ListColumnInfo columnInfo = (Attendance_Students_ListColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
        long pkColumnIndex = columnInfo.unique_IDIndex;
        com.ajstudios.easyattendance.realm.Attendance_Students_List object = null;
        while (objects.hasNext()) {
            object = (com.ajstudios.easyattendance.realm.Attendance_Students_List) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ajstudios.easyattendance.realm.Attendance_Students_List object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
    ...
    public static com.ajstudios.easyattendance.realm.Attendance_Students_List createDetachedCopy(com.ajstudios.easyattendance.realm.Attendance_Students_List realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ajstudios.easyattendance.realm.Attendance_Students_List unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ajstudios.easyattendance.realm.Attendance_Students_List();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ajstudios.easyattendance.realm.Attendance_Students_List) cachedObject.object;
            }
            unmanagedObject = (com.ajstudios.easyattendance.realm.Attendance_Students_List) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface unmanagedCopy = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) unmanagedObject;
        com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface realmSource = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) realmObject;
    ...
    static com.ajstudios.easyattendance.realm.Attendance_Students_List update(Realm realm, Attendance_Students_ListColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Attendance_Students_List realmObject, com.ajstudios.easyattendance.realm.Attendance_Students_List newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface realmObjectTarget = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) realmObject;
        com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface realmObjectSource = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxyInterface) newObject;
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Students_List.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addString(columnInfo.studentNameIndex, realmObjectSource.realmGet$studentName());
    ...
    public boolean equals(Object o) {
        ...
        com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy aAttendance_Students_List = (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy)o;
