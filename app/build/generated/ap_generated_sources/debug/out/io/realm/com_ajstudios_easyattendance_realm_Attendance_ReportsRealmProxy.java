...
public class com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy extends com.ajstudios.easyattendance.realm.Attendance_Reports
    implements RealmObjectProxy, com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface {
    ...
    private ProxyState<com.ajstudios.easyattendance.realm.Attendance_Reports> proxyState;
    private RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> attendance_students_listsRealmList;

    com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ajstudios.easyattendance.realm.Attendance_Reports>(this);
    ...
    public RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> realmGet$attendance_students_lists() {
        ...
        if (attendance_students_listsRealmList != null) {
            ...
            attendance_students_listsRealmList = new RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List>(com.ajstudios.easyattendance.realm.Attendance_Students_List.class, osList, proxyState.getRealm$realm());
            return attendance_students_listsRealmList;
        }
    }
    ...
    public void realmSet$attendance_students_lists(RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> original = value;
                value = new RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List>();
                for (com.ajstudios.easyattendance.realm.Attendance_Students_List item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.ajstudios.easyattendance.realm.Attendance_Students_List linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.ajstudios.easyattendance.realm.Attendance_Reports createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attendance_students_lists")) {
            excludeFields.add("attendance_students_lists");
        }
        com.ajstudios.easyattendance.realm.Attendance_Reports obj = realm.createObjectInternal(com.ajstudios.easyattendance.realm.Attendance_Reports.class, true, excludeFields);

        final com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) obj;
        if (json.has("date")) {
            if (json.isNull("date")) {
        ...
        if (json.has("attendance_students_lists")) {
            if (json.isNull("attendance_students_lists")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.ajstudios.easyattendance.realm.Attendance_Students_List item = com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.ajstudios.easyattendance.realm.Attendance_Reports createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.ajstudios.easyattendance.realm.Attendance_Reports obj = new com.ajstudios.easyattendance.realm.Attendance_Reports();
        final com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface objProxy = (com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$attendance_students_lists(new RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.ajstudios.easyattendance.realm.Attendance_Students_List item = com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$attendance_students_lists().add(item);
                    }
                    reader.endArray();
                }
    ...
    private static com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Reports.class), false, Collections.<String>emptyList());
        io.realm.com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy obj = new io.realm.com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ajstudios.easyattendance.realm.Attendance_Reports copyOrUpdate(Realm realm, Attendance_ReportsColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Attendance_Reports object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Attendance_Reports) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.ajstudios.easyattendance.realm.Attendance_Reports copy(Realm realm, Attendance_ReportsColumnInfo columnInfo, com.ajstudios.easyattendance.realm.Attendance_Reports newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ajstudios.easyattendance.realm.Attendance_Reports) cachedRealmObject;
        }

        com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface realmObjectSource = (com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) newObject;

        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Reports.class);
        ...
        io.realm.com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> attendance_students_listsList = realmObjectSource.realmGet$attendance_students_lists();
        if (attendance_students_listsList != null) {
            RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> attendance_students_listsRealmList = realmObjectCopy.realmGet$attendance_students_lists();
            attendance_students_listsRealmList.clear();
            for (int i = 0; i < attendance_students_listsList.size(); i++) {
                com.ajstudios.easyattendance.realm.Attendance_Students_List attendance_students_listsItem = attendance_students_listsList.get(i);
                com.ajstudios.easyattendance.realm.Attendance_Students_List cacheattendance_students_lists = (com.ajstudios.easyattendance.realm.Attendance_Students_List) cache.get(attendance_students_listsItem);
                if (cacheattendance_students_lists != null) {
                    attendance_students_listsRealmList.add(cacheattendance_students_lists);
                } else {
                    attendance_students_listsRealmList.add(com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.copyOrUpdate(realm, (com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.Attendance_Students_ListColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Students_List.class), attendance_students_listsItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.ajstudios.easyattendance.realm.Attendance_Reports object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Reports.class);
        long tableNativePtr = table.getNativePtr();
        Attendance_ReportsColumnInfo columnInfo = (Attendance_ReportsColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Reports.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$date = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$date();
        if (realmGet$date != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dateIndex, rowIndex, realmGet$date, false);
        }
        String realmGet$monthOnly = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$monthOnly();
        ...
        String realmGet$dateOnly = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$dateOnly();
        if (realmGet$dateOnly != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.dateOnlyIndex, rowIndex, realmGet$dateOnly, false);
        }
        String realmGet$classId = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$classId();
        if (realmGet$classId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.classIdIndex, rowIndex, realmGet$classId, false);
        }
        String realmGet$date_and_classID = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$date_and_classID();
        ...
        String realmGet$classname = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$classname();
        ...
        String realmGet$subjName = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$subjName();
        if (realmGet$subjName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.subjNameIndex, rowIndex, realmGet$subjName, false);
        }

        RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> attendance_students_listsList = ((com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) object).realmGet$attendance_students_lists();
        if (attendance_students_listsList != null) {
            ...
            for (com.ajstudios.easyattendance.realm.Attendance_Students_List attendance_students_listsItem : attendance_students_listsList) {
                ...
                if (cacheItemIndexattendance_students_lists == null) {
                    cacheItemIndexattendance_students_lists = com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.insert(realm, attendance_students_listsItem, cache);
                }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        Attendance_ReportsColumnInfo columnInfo = (Attendance_ReportsColumnInfo) realm.getSchema().getColumnInfo(com.ajstudios.easyattendance.realm.Attendance_Reports.class);
        com.ajstudios.easyattendance.realm.Attendance_Reports object = null;
        while (objects.hasNext()) {
            object = (com.ajstudios.easyattendance.realm.Attendance_Reports) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ajstudios.easyattendance.realm.Attendance_Reports object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.ajstudios.easyattendance.realm.Attendance_Reports.class);
        ...
        if (attendance_students_listsList != null && attendance_students_listsList.size() == attendance_students_listsOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexattendance_students_lists = cache.get(attendance_students_listsItem);
                if (cacheItemIndexattendance_students_lists == null) {
                    cacheItemIndexattendance_students_lists = com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.insertOrUpdate(realm, attendance_students_listsItem, cache);
                }
    ...
    public static com.ajstudios.easyattendance.realm.Attendance_Reports createDetachedCopy(com.ajstudios.easyattendance.realm.Attendance_Reports realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ajstudios.easyattendance.realm.Attendance_Reports unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ajstudios.easyattendance.realm.Attendance_Reports();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ajstudios.easyattendance.realm.Attendance_Reports) cachedObject.object;
            }
            unmanagedObject = (com.ajstudios.easyattendance.realm.Attendance_Reports) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface unmanagedCopy = (com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) unmanagedObject;
        com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface realmSource = (com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> managedattendance_students_listsList = realmSource.realmGet$attendance_students_lists();
            RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List> unmanagedattendance_students_listsList = new RealmList<com.ajstudios.easyattendance.realm.Attendance_Students_List>();
            ...
            for (int i = 0; i < size; i++) {
                com.ajstudios.easyattendance.realm.Attendance_Students_List item = com_ajstudios_easyattendance_realm_Attendance_Students_ListRealmProxy.createDetachedCopy(managedattendance_students_listsList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy aAttendance_Reports = (com_ajstudios_easyattendance_realm_Attendance_ReportsRealmProxy)o;
